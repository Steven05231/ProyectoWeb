        ...
        <div class="contenido__medio">
            ...
            <div class="contenido__central">
                <section class="caja">
                    ...
                    <div class="contenidoregistros">
                        <div class="cajacademico">
                            <p>Participación en redes  académicas de cooperación  internacional.</p>
                        </div>
                            <div class="boton">
                                <input type="button" class="btn-main" value="INGRESAR">
                            </div>
                ...
                <div class="contenidoregistros">
                        <div class="cajacademico">
                            <p>Movilidad nacional/internacional.</p>
                        </div>
                        <div class="boton">
                            <input type="button" class="btn-main" value="INGRESAR">
                            </div>
                    ...
                    <div class="contenidoregistros">
                        <div class="cajacademico">
                            <p>Participación en eventos  nacionales o internacionales.</p>
                        </div>
                        <div class="boton contenidocaja">
                            <input type="button" class="btn-main" value="INGRESAR">
                        </div>
                    ...
                    <div class="contenidoregistros">
                        <div class="cajacademico">
                            <p style="text-align: left">Talleres, seminarios y otros  eventos.</p>
                        </div>
                            <div class="boton">
                                <input type="button" class="btn-main" value="INGRESAR">
                            </div>
                    ...
                    <div class="contenidoregistros">
                        <div class="cajacademico">
                            <p>Dirección de trabajo de grado.</p>
                        </div>
                        <div class="boton">
                            <input type="button" class="btn-main" value="INGRESAR">
                        </div>
